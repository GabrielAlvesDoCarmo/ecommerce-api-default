...
import {changeStatusSchema, newOrderSchema, searchQueryOrderSchema} from "../models/order.model.js";
...
ordersRoute.post(
    ...
    asyncHandler(OrderController.save)
)
ordersRoute.get(
    "/orders",
    celebrate({[Segments.QUERY]: searchQueryOrderSchema}),
    asyncHandler(OrderController.search)
)
ordersRoute.get(
    "/orders/:id/items",
